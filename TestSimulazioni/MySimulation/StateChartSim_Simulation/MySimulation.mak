...
TARGET_NAME=MySimulation

all : $(TARGET_NAME)$(EXE_EXT) MySimulation.mak

TARGET_MAIN=MainMySimulation
...
StateChartSim.o : StateChartSim.cpp StateChartSim.h    SimulazioneStateWithPAnel.h 
	@echo Compiling StateChartSim.cpp
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o StateChartSim.o StateChartSim.cpp




SimulazioneStateWithPAnel.o : SimulazioneStateWithPAnel.cpp SimulazioneStateWithPAnel.h    StateChartSim.h 
	@echo Compiling SimulazioneStateWithPAnel.cpp
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o SimulazioneStateWithPAnel.o SimulazioneStateWithPAnel.cpp
...
$(TARGET_NAME)$(EXE_EXT): $(OBJS) $(ADDITIONAL_OBJS) $(TARGET_MAIN)$(OBJ_EXT) MySimulation.mak
...
$(TARGET_NAME)$(LIB_EXT) : $(OBJS) $(ADDITIONAL_OBJS) MySimulation.mak
...
clean:
	@echo Cleanup
	$(RM) StateChartSim.o
	$(RM) SimulazioneStateWithPAnel.o
