...
//!	Generated Date	: Fri, 5, Aug 2022  
	File Path	: MySimulation/Calculator_Simulation/Calculator.cpp
*********************************************************************/
...
//#[ ignore
#define SimulazioneActivityCalculator_Calculator_Calculator_SERIALIZE OM_NO_OP
//#]

//## package SimulazioneActivityCalculator
...
Calculator::Calculator() : X(7), Y(5), Z(0) {
    NOTIFY_ACTIVITY_CONSTRUCTOR(Calculator, Calculator(), 0, SimulazioneActivityCalculator_Calculator_Calculator_SERIALIZE);
}
...
IMPLEMENT_ACTIVITY_META_P(Calculator, SimulazioneActivityCalculator, SimulazioneActivityCalculator, false, OMAnimatedCalculator)
#endif // _OMINSTRUMENT
