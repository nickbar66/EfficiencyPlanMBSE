...
OBJS= \
  Calculator.o \
  SimulazioneActivityCalculator.o
...
Calculator.o : Calculator.cpp Calculator.h    SimulazioneActivityCalculator.h 
...
SimulazioneActivityCalculator.o : SimulazioneActivityCalculator.cpp SimulazioneActivityCalculator.h    Calculator.h 
	@echo Compiling SimulazioneActivityCalculator.cpp
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o SimulazioneActivityCalculator.o SimulazioneActivityCalculator.cpp
...
clean:
	@echo Cleanup
	$(RM) Calculator.o
	$(RM) SimulazioneActivityCalculator.o
